    ...
    <div class="p-10 milkstore-text text-xl w-full">
        ...
        <div class="flex justify-center items-center">
            <div class="relative w-2/4">
                <input type="text" ref="searchBar" placeholder="Subject" v-model="searchQuery"
        ...
        <div class="flex flex-row justify-center gap-4 py-4 items-center w-full">
            ...
            <button @click="SearchByFilter"
                class="flex rounded-full justify-center items-center bg-custom-red-wine text-white border border-custom-red-wine p-2 focus:outline-none focus:border-blue-500">
                <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
