  ...
  <div class="flex-row h-screen flex">
    ...
    <div class="h-screen bg-white flex flex-col px-40 gap-4">
      ...
      <div class="flex flex-row justify-between">
        <div class="text-card flex justify-center">
          Ticket Code: {{ useRoute().params.id.slice(1, 6) }}
        </div>
        <button
          @click="deleteTicket"
          class="flex flex-row bg-custom-700 milkstore-text text-xl h-15 hover:bg-red-700 text-white font-bold py-2 px-4 items-center justify-center"
        >
      ...
      <div class="flex w-full flex-row">
        ...
        <div class="flex flex-col main-content w-2/3 gap-4">
          <div class="bg-white h-52 flex flex-col border border-black">
            <div
              class="bg-custom-700 h-16 flex items-center justify-between px-4 text-white"
            >
              ...
              <div class="relative">
                ...
                <button
                  ...
                  class="text-black border px-4 bg-white h-10 focus:outline-none focus:border-blue-500"
                >
                ...
                <div
                  v-if="isOpen"
                  class="text-black absolute z-10 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg"
                >
                  <ul>
                    <li
          ...
          <div class="bg-white h-52 flex flex-col border border-black">
            <div
              class="bg-custom-red-wine h-16 flex items-center justify-between px-4 text-white"
            >
              <div>RESPONSE</div>
          ...
          <div class="flex justify-end">
            <a
              ...
              type="button"
              class="flex flex-row items-center milkstore04-text pr-4"
            >
              <svg
                v-if="!this.url"
                fill="#000000"
              ...
              >
                <path
                  id="primary"
                  d="M5.23,8.73,9.18,4.78a6.1,6.1,0,0,1,8.61,0h0a6.09,6.09,0,0,1,0,8.6l-6.43,6.43a4,4,0,0,1-5.74,0h0a4.06,4.06,0,0,1,0-5.73l6.74-6.74a2,2,0,0,1,2.87,0h0a2,2,0,0,1,0,2.87l-7,7"
                  style="
                    fill: none;
                    stroke: rgb(0, 0, 0);
                    stroke-linecap: round;
            ...
            <button
              @click="submitForm"
              type="submit"
              class="bg-custom-red-wine milkstore-text text-xl w-36 h-15 hover:bg-red-500 text-white font-bold py-2 px-4 items-center justify-center"
            >
        ...
        <!-- RIGHT SIDEBAR -->
        <div
          class="flex flex-col text-white w-auto milkstore-text gap-4 justify-center items-end text-lg"
        >
          <!-- REQUESTER INFO -->
          <div
            id="requester-info"
            class="p-2 h-25 w-3/4 rounded bg-custom-700 flex flex-col text-lg"
          >
            <div id="requester-header" class="flex flex-row justify-center">
              ...
              <span class="w-2/3"> REQUESTER INFORMATION </span>
            </div>
            ...
            <div id="requester-user" class="flex flex-row items-center">
              <span class="w-1/3 flex justify-center mb-2">
                ...
                <img
                  src="../../src/assets/images/7Brew_Tertiary_2.png"
                  alt=""
                  width="65px"
                  height="65px"
                />
              ...
              <span class="flex flex-col w-2/3">
                ...
                <span
                  v-html="department"
                  class="text-xxs milkstore04-text"
                ></span>
              </span>
            </div>
          </div>
          ...
          <div
            id="ticket-info"
            class="h-auto w-3/4 bg-blue-200 bg-custom-700 rounded flex flex-col"
          >
            <div
              id="ticket-info-header"
              class="flex flex-row justify-center pt-3"
            >
              ...
              <span class="w-2/3"> TICKET INFORMATION </span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-2 flex p-4">
              <div class="flex flex-col">
                ...
                <div class="flex flex-row gap-2 items-center">
                  ...
                  <button @click="switchBetweenPriorities">
                    {{ this.priority }}
                  </button>
                </div>
              </div>
              ...
              <div class="flex flex-col">
                ...
                <div class="flex flex-row gap-2 items-center">
                  <span
                    ...
                    "
                    v-html="status.toLocaleLowerCase()"
                    class="text-blue-400"
                  ></span>
                  <span
                    v-if="status.toLocaleLowerCase() == 'closed'"
                    v-html="status.toLocaleLowerCase()"
                    class="text-red-400"
                  ></span>
                </div>
          ...
          >
            ...
            >
              ...
              <span class="w-2/3"> SIMILAR TICKETS </span>
            </div>

            <div class="flex flex-col p-4 justify-center">
              <hr />
              <div>
                <span class="pl-3"> #2014 HYGIENE </span>
                <hr />
              </div>
              <div>
                <span class="pl-3"> #2014 HYGIENE </span>
  ...
  methods: {
    submitForm: async function () {
      ...
      set(
        child(
          ref(db),
          "users/" + this.userpath + "/tickets_assigned/" + useRoute().params.id
        ),
        {
    ...
    readTicket(reference) {
      get(reference).then((snapshot) => {
        const formattedDate = DateTime.fromFormat(
          snapshot.val().ticket_date.slice(0, 15),
          "ccc MMM dd yyyy"
        ).toFormat("M/d/yy");
        const formattedSolvedByDate = !snapshot.val().ticket_solved_by_date
          ? ""
          : DateTime.fromFormat(
              snapshot.val().ticket_solved_by_date.slice(0, 15),
              "ccc MMM dd yyyy"
            ).toFormat("M/d/yy");
