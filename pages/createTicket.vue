<template>
  <div class="flex-row h-screen flex">
    <Menu />
    <div class="px-40 main-title text-xl pt-10">
      <!-- TITLE -->
      ...
      <form @submit.prevent="submitForm" id="loginForm">
        ...
        >
          ...
          <input
            ...
            type="text"
            id="subject"
            class="milkstore04-text text-sm pl-3 col-span-2 pr-4 py-2 border border-red-700 focus:outline-none focus:border-blue-500 text-xl w-full"
            placeholder="Hygiene issues"
            required
          />
          ...
          <div class="col-span-2">
            <DropboxComp
              ...
              :default_caption="''"
              :text_type="'milkstore04-text text-sm'"
              :options="departments"
              @input="handleSelectedDepartment"
            />
          </div>
